...
```{r}
setwd("C:/Users/lj015625/Desktop/DataMining Class/ADM/data")
...
### A note on the centroid values

Each centroid is the average value for a given characteristic in that cluster.

So for cluster 1, the top centroid value is music (2.43). The average number of times that the the word "music" was used in cluster 1 is 2.43 times. 
...
**Cluster 5** (4,500 teens): Moderate centroid values: hair, shopping, cute, soccer, basketball, mall, music, church, football, softball. Who are these "kids"? Another "basket cases"?
...
# checking now to see how the centroids are calculated
aggregate(teens$music~teens$cluster, FUN="sum")
teen_clusters_5$size
band_cluster1_centroid=10247/4216
...
oil_pam <- pam(dissimilarity.matrix,4)
