...
sms_raw <- read.csv("C:/Users/lj015625/Desktop/DataMining Class/Applied_Data_Mining/data/sms_spam.csv", stringsAsFactors = FALSE)
...
sms_test_pred2 <- predict(sms_classifier2, sms_test, positive="spam")
