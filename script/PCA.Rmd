...
```{r}
imbd<-read.csv("C:/Users/lj015625/Desktop/DataMining Class/ADM/data/movie_metadata.csv")
```
...
# split plot keywords to five columns
...
write(keywords_basket,file="C:/Users/lj015625/Desktop/DataMining Class/Applied_Data_Mining/data/keywords_basket") #write out as a text file

kb<-read.transactions("C:/Users/lj015625/Desktop/DataMining Class/Applied_Data_Mining/data/keywords_basket", format="basket", sep=",") #cannot use the read.transactions function without writing out to an output file first.
...
str(movie_num)
movie_num$duration <- as.numeric(movie_num$duration)
...
```{r}
library(lubridate)
LMCI_large<-read.csv("C:/Users/lj015625/Desktop/DataMining Class/ADM/data/LMCI_month.csv")
LMCI_small<-read.csv("C:/Users/lj015625/Desktop/DataMining Class/ADM/data/LMCI_week.csv")
...
bakery <- read.csv("C:/Users/lj015625/Desktop/DataMining Class/Applied_Data_Mining/data/bakery-binary.csv") 
str(bakery)
#View(bakery)
