...
```{r}
imbd<-read.csv("C:/Users/lj015625/Desktop/DataMining Class/Applied_Data_Mining/data/movie_metadata.csv")
```
...
```{r}
library(lubridate)
LMCI_large<-read.csv("C:/Users/lj015625/Desktop/DataMining Class/Applied_Data_Mining/data/LMCI_month.csv")
LMCI_small<-read.csv("C:/Users/lj015625/Desktop/DataMining Class/Applied_Data_Mining/data/LMCI_week.csv")
