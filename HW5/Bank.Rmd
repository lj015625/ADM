...
We used the significant variables from Random Forest decision tree for the logistic regression model.
...
- The month of March, May, June, September, October, December increases the chance client subscribe a term deposit.
...
The black box Neural Network model produced best sensitivity rate 49.2%.  We also used five-fold cross validation on training data set.
...
- *Bank does more successful marketing campaigns in month of March, May, June, September, October, December*.  
